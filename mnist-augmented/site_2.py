...
from dataset import cook_mnist_rotated_bg_complete_increment as inc_dataset  
from yann.utils.pickle import load

if __name__ == '__main__':
    
    # simply locations
    gan = 24   # which epoch of gan do you want transfer to site 2 ?    
    ...
    base_params = load(site_1_root + '/resultor/base-network/params/epoch_99.pkl') 
